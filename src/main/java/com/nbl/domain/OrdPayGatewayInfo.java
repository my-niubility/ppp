...
public class OrdPayGatewayInfo implements Serializable {
	...
	public String toString() {
		return "OrdPayGatewayInfo [token=" + token + ", tradeOrderId=" + tradeOrderId + ", fundsType=" + fundsType + ", tradeAmt=" + tradeAmt + ", custId=" + custId + ", tradeTalAmt=" + tradeTalAmt
				+ ", redEnvAmt=" + redEnvAmt + ", channelCode=" + channelCode + "]";
	}
