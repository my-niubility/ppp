...
public class OrdPayQuickInfo implements Serializable {
	...
	public String toString() {
		return "OrdPayQuickInfo [token=" + token + ", tradeOrderId=" + tradeOrderId + ", fundsType=" + fundsType + ", tradeAmt=" + tradeAmt + ", custId=" + custId + ", tradeTalAmt=" + tradeTalAmt
				+ ", redEnvAmt=" + redEnvAmt + ", msgIdenCode=" + msgIdenCode + ", channelCode=" + channelCode + "]";
	}
